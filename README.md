...
This project is about creating a VHDL module and a test bench for a alphanumeric digital lock with state machine.
...
## How it works:
-The Lock Code is a 4-digit code  
-The user enters a combination on the keyboard of the device and presses the "Validatation" key  
* If the code entered is true the lock will wait until the user releases the "Validatation" button to open.
